...
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { clock100 }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
...
set_property -dict {PACKAGE_PIN D10 IOSTANDARD LVCMOS33} [get_ports out_tx_uart]
set_property -dict {PACKAGE_PIN A9 IOSTANDARD LVCMOS33} [get_ports in_rx_uart]
